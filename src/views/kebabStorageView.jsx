                ...
                {props.list.map((item) => {
                    return (
                        item.toString().includes(".") ?
                            <div onClick={() => props.setSelectedFile(item.toString())} key={item} style={{ height: "50px", backgroundColor: "rgb(250, 218, 77)", marginTop: "15px", textAlign: "left", display: "flex", flexDirection: "row", cursor: "pointer" }}>
