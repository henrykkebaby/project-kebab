...
function KebabStoragePresenter(props) {
  ...
  return (
    <div style={{ display: "flex", flexDirection: "row", position: "absolute", bottom: "0px", top: "1.5cm", left: "0px", right: "0px" }}>
      ...
      {isCreatingFolder && <input id="folderInputMobile" type="text" autoComplete="off" style={{ position: "fixed", height: "60px", width: "100%", left: "50%", bottom: "1.5cm", transform: "translate(-50%, 0)", fontSize: "0.7cm" }} placeholder="Create a folder here..." onKeyPress={event => { if (event.key === 'Enter') { createFolder(); setIsCreatingFolder(false); } }} />}
